...
1. a tidy data set based on the original data set: [tidy_data.txt](https://github.com/zezutom/GetAndCleanDataProject/blob/master/tidy_data.txt) and [tidy_data.csv (nicely formatted on GitHub)](https://github.com/zezutom/GetAndCleanDataProject/blob/master/tidy_data.csv)
